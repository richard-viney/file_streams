...
pub type TextEncoding {
  /// The Unicode UTF-8 text encoding. This is the default encoding.
  Unicode

  /// The ISO 8859-1 (Latin-1) text encoding.
  ///
  /// When using this encoding, `file_stream.write_chars()` can only write
  /// Unicode codepoints up to `U+00FF`.
  Latin1
